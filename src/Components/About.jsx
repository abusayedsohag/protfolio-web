...
const About = () => {
    return (
        <div id='about' className='py-10 w-11/12 mx-auto'>
            <div className='flex'>
                <div className="hidden md:flex justify-start drop-shadow-[40px_-40px_80px_rgba(40,15,150,1)]">
                    <img
                        src="./me1.png"
                        width={2000}
                    />
                </div>
                <div className='flex flex-col gap-y-5 text-center md:text-start justify-between'>
                    ...
                    <div>
                        ...
                        <div className='fa-2xl flex justify-center md:justify-start gap-4'>
